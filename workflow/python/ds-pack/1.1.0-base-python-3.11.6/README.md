...
## Image details
### Base image
This image uses [python:3.11.6-slim-bookworm](https://hub.docker.com/layers/library/python/3.11.6-slim-bookworm/images/sha256-25e6046c4bb498c74d00b284580294e3de06c67dc80371418cd95d8140ead9bd?context=explore) as its base which is maintained by [the Docker Community](https://github.com/docker-library/python).
...
```
docker build . -t workflow-python-ds-pack-1.1.0-base-python-3.11.6 --build-arg PEAK_USER_ID=8877
```
